...
export type Experience = { org: string; role: string; period: string; detail: string };
export type Education = { org: string; title: string; period: string };
export type LabItem = { name: string; note: string; href: string; tags: string[] };
...
type Content = {
  ...
  colophon: { eyebrow: string; title: string; lead: string; body: string; tech: string[] };
  stack: { eyebrow: string; title: string; note: string; groups: { label: string; items: string }[] };
  about: { eyebrow: string; title: string; body: string[]; highlightsLabel: string; highlights: string[] };
  services: { eyebrow: string; title: string; items: { n: string; title: string; body: string; tags: string[] }[] };
...
const en: Content = {
  ...
  hero: {
    ...
    location: "Moscow",
    marker: "Portfolio",
    headline: ["I design and build", "the front of the web."],
    accent: "the front",
    intro:
  ...
  stack: {
    ...
    groups: [
      { label: "Frontend", items: "React, Next.js, TypeScript, JavaScript, Effector, REST / DTO" },
      { label: "Styling & motion", items: "Tailwind CSS, styled-components, GSAP, Framer Motion, Three.js / R3F" },
      { label: "Design & tooling", items: "Figma, Storybook, Vite, Webpack, Git, Docker" },
    ],
  },
  about: {
    eyebrow: "About",
  ...
  work: {
    ...
    title: "Real products, shipped — from investor platforms to industrial sites.",
    projects: [
      {
        name: "Atlas IR",
  ...
  exp: {
    ...
    education: [
      { org: "HSE University", title: "BSc, Business Management — Graduate School of Business", period: "2026" },
      { org: "HSE — Minor", title: "Data Mining — foundations of machine learning", period: "2024" },
      { org: "HSE — Minor", title: "Applied Programming — algorithms & data structures", period: "2025" },
    ],
  },
  lab: {
    eyebrow: "Lab",
    ...
    items: [
      { name: "Fantasy Auth Form", note: "A two-screen authorization flow for new and returning users.", href: "https://pipchenkovaa.github.io/Authorization-Form/", tags: ["SCSS", "JS"] },
      { name: "Parallax 3D Page", note: "A scrolling page built around a GSAP parallax effect.", href: "https://pipchenkovaa.github.io/Webpage-With-A-Parallax-Effect/", tags: ["GSAP", "JS"] },
      { name: "Apple / Mac Site", note: "A multi-page site study in Apple's interface language.", href: "https://pipchenkovaa.github.io/Apple_Mac-Website/", tags: ["HTML", "CSS", "JS"] },
      { name: "Fashion News", note: "A minimalist news page — first build with Tailwind CSS.", href: "https://pipchenkovaa.github.io/News-Webpage/", tags: ["Tailwind", "JS"] },
    ],
  },
  contact: {
    eyebrow: "Contact",
...
const ru: Content = {
  ...
  stack: {
    ...
    groups: [
      { label: "Frontend", items: "React, Next.js, TypeScript, JavaScript, Effector, REST / DTO" },
      { label: "Стили и анимация", items: "Tailwind CSS, styled-components, GSAP, Framer Motion, Three.js / R3F" },
      { label: "Дизайн и тулинг", items: "Figma, Storybook, Vite, Webpack, Git, Docker" },
    ],
  },
  about: {
    eyebrow: "Обо мне",
  ...
  work: {
    ...
    title: "Реальные продукты в проде — от инвест-платформ до промышленных сайтов.",
    projects: [
      {
        name: "Atlas IR",
  ...
  exp: {
    ...
    education: [
      { org: "НИУ ВШЭ", title: "Бакалавр, бизнес-менеджмент — Высшая школа бизнеса", period: "2026" },
      { org: "НИУ ВШЭ — майнор", title: "Интеллектуальный анализ данных — основы ML", period: "2024" },
      { org: "НИУ ВШЭ — майнор", title: "Прикладное программирование — алгоритмы и структуры данных", period: "2025" },
    ],
  },
  lab: {
    eyebrow: "Лаборатория",
    ...
    items: [
      { name: "Fantasy Auth Form", note: "Двухэкранная форма авторизации для новых и вернувшихся пользователей.", href: "https://pipchenkovaa.github.io/Authorization-Form/", tags: ["SCSS", "JS"] },
      { name: "Parallax 3D Page", note: "Скролл-страница вокруг параллакс-эффекта на GSAP.", href: "https://pipchenkovaa.github.io/Webpage-With-A-Parallax-Effect/", tags: ["GSAP", "JS"] },
      { name: "Apple / Mac Site", note: "Многостраничный этюд в интерфейсном языке Apple.", href: "https://pipchenkovaa.github.io/Apple_Mac-Website/", tags: ["HTML", "CSS", "JS"] },
      { name: "Fashion News", note: "Минималистичная новостная страница — первый билд на Tailwind.", href: "https://pipchenkovaa.github.io/News-Webpage/", tags: ["Tailwind", "JS"] },
    ],
  },
  contact: {
    eyebrow: "Контакты",
